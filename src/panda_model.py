...
from .utils import PANDA_OG_URDF
...
class Panda(ERobot):
    ...
    def __init__(self):
        ...
        links, name, urdf_string, urdf_filepath = self.URDF_read("/home/liam/dev/bi-manual-forceful-manipulation/bi-manual-tamp/examples/pybullet/utils/models/bi_panda/panda.urdf", tld='./'
        )
